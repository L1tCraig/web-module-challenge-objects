...
function createMenuItem(item, cost, meal){
    return {name: item, price: cost, category: meal};
   }
...
console.log(createMenuItem('corn nuggets',4,'side'))
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function discounted(customerType){
...
reviews.push({
  name: 'Craig', 
  rating: 4.7, 
  feedback: 'Good food, great service!'
});
console.log(reviews);
...
reviews[7].feedback = 'this place is chil with really cool people, great for getting work done on weekdays';
